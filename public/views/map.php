...
<div class="page-content" style="padding-bottom:0;overflow:hidden;">
    <div class="map-full-container">
        ...
        <div class="map-fabs">
            <button class="map-fab" id="fitBtn"><i class="fa-solid fa-expand"></i></button>
        </div>
...
function buildPopup(s) {
    return `<div class="popup-card">
        ...
        <div class="popup-brand">${esc(s.brand)} · ${s.sockets?s.sockets.length:0} soket</div>
        <div class="popup-actions">
            <a href="${PAGES.station}?id=${s.id}" class="popup-btn pb-primary"><i class="fa-solid fa-circle-info"></i> Detay</a>
